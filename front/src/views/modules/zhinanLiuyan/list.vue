                ...
                <el-row class="ad" :style="{justifyContent:contents.btnAdAllBoxPosition=='1'?'flex-start':contents.btnAdAllBoxPosition=='2'?'center':'flex-end'}">
                    <el-form-item>
                        ...
                        <a style="text-decoration:none" class="el-button el-button--success"
                           ...
                           href="http://localhost:8080/shequyiliaofw/upload/zhinanLiuyanMuBan.xls"
                        >批量导入指南留言数据模板</a>
                        &nbsp;
                        <el-upload
                                v-if="isAuth('zhinanLiuyan','导入导出')"
                ...
                <el-table class="tables" :size="contents.tableSize" :show-header="contents.tableShowHeader"
                    ...
                    <el-table-column width="300" :align="contents.tableAlign"
                        ...
                        <template slot-scope="scope">
                            ...
                            <el-button v-if="isAuth('zhinanLiuyan','修改')" type="primary" icon="el-icon-edit" size="mini" @click="addOrUpdateHandler(scope.row.id)">回复</el-button>
        ...
        methods: {
            chartDialog() {
                ...
                let params = {
                    ...
                    thisTable : {//当前表
                        tableName :'zhinan_liuyan',//当前表表名,
                        sumColum : 'zhinan_liuyan_number', //求和字段
                        date : 'insert_time',//分组日期字段
                        // string : 'zhinan_liuyan_name',//分组字符串字段
                        // types : 'zhinan_liuyan_types',//分组下拉框字段
                    },
                    // joinTable : {//级联表（可以不存在）
                ...
                //         groupColumn: "zhinan_liuyan_types",
                //// riqi :getMonthFormat(_this.echartsDate),//年月
                //     }
                //     this.$http({
            ...
            wuyong(id) {
                ...
                _this.$confirm(`确定    操作?`, "提示", {confirmButtonText: "确定",cancelButtonText: "取消",type: "warning"
                    ...
                    _this.$http({
                        url: "zhinanLiuyan/update",
                        method: "post",
                        data: {
                            id:id,
//                            zhinanLiuyanTypes:zhinanLiuyanTypes,
                        }
                    }).then(({data}) => {
                        if(data && data.code === 0){
