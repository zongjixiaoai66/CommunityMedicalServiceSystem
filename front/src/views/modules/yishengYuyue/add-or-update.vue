    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="就诊识别码" prop="yishengYuyueUuidNumber">
                       <el-input v-model="ruleForm.yishengYuyueUuidNumber"
                                 placeholder="就诊识别码" clearable  :readonly="ro.yishengYuyueUuidNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="就诊识别码" prop="yishengYuyueUuidNumber">
                           <el-input v-model="ruleForm.yishengYuyueUuidNumber"
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="时间类型" prop="timeTypes">
                        <el-select v-model="ruleForm.timeTypes" :disabled="ro.timeTypes" placeholder="请选择时间类型">
                            <el-option
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="时间类型" prop="timeValue">
