                ...
                <el-row :gutter="20" class="slt" :style="{justifyContent:contents.searchBoxPosition=='1'?'flex-start':contents.searchBoxPosition=='2'?'center':'flex-end'}">
                    ...
                    <el-form-item :label="contents.inputTitle == 1 ? '结束挂号时间' : ''">
                     ...
                     <el-form-item :label="contents.inputTitle == 1 ? '时间类型' : ''">
                        <el-select v-model="searchForm.timeTypes" placeholder="请选择时间类型">
                ...
                <el-row class="ad" :style="{justifyContent:contents.btnAdAllBoxPosition=='1'?'flex-start':contents.btnAdAllBoxPosition=='2'?'center':'flex-end'}">
                    <el-form-item>
                        ...
                        <a style="text-decoration:none" class="el-button el-button--success"
                           ...
                           href="http://localhost:8080/shequyiliaofw/upload/yishengYuyueMuBan.xls"
                        >批量导入挂号数据模板</a>
                        &nbsp;
                        <el-upload
                                v-if="isAuth('yishengYuyue','导入导出')"
            ...
            chartDialog() {
                ...
                let params = {
                    ...
                    thisTable : {//当前表
                        ...
                        date : 'yisheng_yuyue_time',//分组日期字段
