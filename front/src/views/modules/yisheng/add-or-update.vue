        ...
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="挂号须知" prop="yishengYishengYuyue">
                       <el-input v-model="ruleForm.yishengYishengYuyue"
                                 placeholder="挂号须知" clearable  :readonly="ro.yishengYishengYuyue"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
               ...
               <el-col :span="12">
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info' && !ro.yishengContent"  label="履历介绍" prop="yishengContent">
