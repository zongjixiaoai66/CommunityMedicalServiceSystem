  ...
  <div>
    ...
    >  
     <el-row>
         ...
         <el-col :span="12">
           <el-form-item v-if="flag=='yisheng'"  label='挂号须知' prop="yishengYishengYuyue">
               <el-input v-model="ruleForm.yishengYishengYuyue"  placeholder='挂号须知' clearable></el-input>
           </el-form-item>
         </el-col>
...
// 注册表 医生 的级联表
  ...
  methods: {
    ...
    onUpdateHandler() {
                         ...
                         if((!this.ruleForm.yishengYishengYuyue)&& 'yisheng'==this.flag){
