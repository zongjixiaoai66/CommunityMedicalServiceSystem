...
public class YishengChatView extends YishengChatEntity implements Serializable {
	...
	*/
	...
	public YishengChatView() {

	}

	public YishengChatView(YishengChatEntity yishengChatEntity) {
		try {
