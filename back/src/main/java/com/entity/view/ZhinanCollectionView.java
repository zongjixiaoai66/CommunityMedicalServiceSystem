...
public class ZhinanCollectionView extends ZhinanCollectionEntity implements Serializable {
	...
	*/
	...
	private String zhinanCollectionValue;
	...
	public ZhinanCollectionView() {

	}

	public ZhinanCollectionView(ZhinanCollectionEntity zhinanCollectionEntity) {
		try {
			BeanUtils.copyProperties(this, zhinanCollectionEntity);
	...
	* 获取： 类型的值
	*/
	public String getZhinanCollectionValue() {
		return zhinanCollectionValue;
	}
	/**
	* 设置： 类型的值
	*/
	public void setZhinanCollectionValue(String zhinanCollectionValue) {
		this.zhinanCollectionValue = zhinanCollectionValue;
	}
	...
	public String toString() {
		return "ZhinanCollectionView{" +
			", zhinanCollectionValue=" + zhinanCollectionValue +
