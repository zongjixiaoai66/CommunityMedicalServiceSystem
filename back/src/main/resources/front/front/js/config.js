...
var centerMenu = [
    ...
    ,{
        name: '指南收藏',
        url: '../zhinanCollection/list.html'
    }
    ,{
        name: '指南留言',
        url: '../zhinanLiuyan/list.html'
    }
...
// 已废弃,不用了
var adminurl =  "http://localhost:8080/shequyiliaofw/admin/dist/index.html#/login";
